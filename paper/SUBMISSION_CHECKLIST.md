...
- [x] Funding.
- [x] Competing interests and Celonis affiliation.
...
- [ ] Upload the source archive and `cover_letter.pdf` in their designated
  categories.
- [ ] Enter both authors' ORCID identifiers and verify the corresponding-author
  email.
