...
An early project prototype was posted on Preprints.org in July 2026 (\href{https://doi.org/10.20944/preprints202607.0463.v1}{preprint DOI}). The manuscript cites this preprint and includes a dedicated comparison table. The journal version materially replaces the corpus, data model, architecture, latent formulation, objective, deployment decoder, checkpoint-selection protocol, and evaluation; it does not recycle the obsolete preprint's numerical claims as evidence.
