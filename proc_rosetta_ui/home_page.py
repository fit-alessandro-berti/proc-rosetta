...
cards = st.columns(4)
views = [
    ("01", "Artifact workspace", "Import, inspect, and automatically encode artifacts.", "pages/01_workspace.py"),
    ...
    ("04", "Checkpoint dashboard", "Compare trusted runs and inspect training history.", "pages/05_checkpoint.py"),
]
