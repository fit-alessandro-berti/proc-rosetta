...
\end{axis}
\end{tikzpicture}
\caption{Two-dimensional view of cross-artifact neighborhoods for 12 \texttt{complex} families. Each gray triangle connects the event log, Petri net, and process tree representations of one family. PCA is illustrative; all reported retrieval results use the original 96-dimensional vectors.}
\label{fig:pca}
\end{figure*}
