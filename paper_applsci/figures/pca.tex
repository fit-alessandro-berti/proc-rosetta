...
\end{axis}
\end{tikzpicture}
\caption{Joint PCA of event log, Petri net, and process tree embeddings for 12 \texttt{complex} families. Gray triangles connect modalities of one family. PCA is illustrative; all reported retrieval and distance results use the original 96-dimensional vectors.}
\label{fig:pca}
\end{figure}
