...
\end{axis}
\end{tikzpicture}
\caption{Training and macro validation objectives. Stage transitions change task difficulty. Epoch 10 is not eligible for final selection; epoch 11 is the first eligible \texttt{complex}-stage evaluation and is selected.}
\label{fig:training}
\end{figure*}
